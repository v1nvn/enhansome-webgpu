...
* [GPUWeb](https://github.com/gpuweb/gpuweb) ⭐ 5,380 | 🐛 471 | 🌐 Bikeshed | 📅 2026-05-05 - Official GitHub repository.
...
* [Implementation status](https://github.com/gpuweb/gpuweb/wiki/Implementation-Status) ⭐ 5,380 | 🐛 471 | 🌐 Bikeshed | 📅 2026-05-05 - Official W3C Group.
...
* [wgpu](https://github.com/gfx-rs/wgpu) ⭐ 17,066 | 🐛 1,140 | 🌐 Rust | 📅 2026-05-07 - Mozilla implementation used in Firefox. Like Dawn, can be used as a standalone package.
* [sokol](https://github.com/floooh/sokol/) ⭐ 9,833 | 🐛 151 | 🌐 C | 📅 2026-05-06 - Simple STB-style cross-platform libraries for C and C++.
* [ChartGPU](https://github.com/chartgpu/chartgpu) ⭐ 3,082 | 🐛 9 | 🌐 TypeScript | 📅 2026-05-01 - High-performance charting library built on WebGPU, handles 1M+ data points at 60fps.
* [React Native WebGPU](https://github.com/wcandillon/react-native-webgpu) ⭐ 1,094 | 🐛 39 | 🌐 TypeScript | 📅 2026-04-14 - React Native implementation of WebGPU using Dawn.
* [webgpu-headers](https://github.com/webgpu-native/webgpu-headers) ⭐ 558 | 🐛 49 | 🌐 C++ | 📅 2026-03-31 - C/C++ headers.
* [WebGPU-C++](https://github.com/eliemichel/WebGPU-Cpp) ⭐ 480 | 🐛 11 | 🌐 C++ | 📅 2025-09-03 - A single-file zero-overhead C++ idiomatic wrapper, by @eliemichel.
* [RedGPU](https://github.com/redcamel/RedGPU) ⭐ 379 | 🐛 17 | 🌐 TypeScript | 📅 2026-05-07 - JavaScript WbeGPU library, by [@redcamel](https://github.com/redcamel).
* [wgsl\_reflect](https://github.com/brendan-duncan/wgsl_reflect) ⭐ 269 | 🐛 7 | 🌐 TypeScript | 📅 2026-04-16 - A WebGPU Shading Language parser and reflection library for JavaScript.
* [WESL](https://github.com/wgsl-tooling-wg/wesl-spec/blob/main/README.md) ⭐ 242 | 🐛 86 | 📅 2026-05-06 - WGSL extensions for `import`, `@if`, and more.
* [WebGPU .NET](https://github.com/WaveEngine/WebGPU.NET) ⭐ 196 | 🐛 0 | 🌐 C# | 📅 2026-04-07 - .NET bindings, built on top of wgpu.
...
* [webgpu-inspector](https://github.com/brendan-duncan/webgpu_inspector) ⭐ 320 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-03 - Inspection debugger for WebGpu.
* [webgpu-profiler](https://crates.io/crates/wgpu-profiler) - A profiler for Rust + WebGPU.

These have not been updated for a while:

* [webgpu-devtools](https://github.com/takahirox/webgpu-devtools) ⭐ 189 | 🐛 19 | 🌐 JavaScript | 📅 2023-05-04 - Web browser extention.
...
* [Three.js WebGPU examples](https://threejs.org/examples/?q=webgpu) - A collection of examples from three.js using the WebGPU renderer - [Repository](https://github.com/mrdoob/three.js/tree/dev/examples#:~:text=webgpu_compute.html) ⭐ 112,344 | 🐛 502 | 🌐 JavaScript | 📅 2026-05-07
* [WebLLM](https://mlc.ai/web-llm/) - LLM inference engine, by CMU, University of Washington, OctoML, et al - [Repository](https://github.com/mlc-ai/web-llm) ⭐ 17,926 | 🐛 147 | 🌐 TypeScript | 📅 2026-05-06
* [wgpu examples](https://wgpu.rs/examples/) - Official list of examples from the [wgpu](https://wgpu.rs) library - [Repository](https://github.com/gfx-rs/wgpu/tree/trunk/examples) ⭐ 17,066 | 🐛 1,140 | 🌐 Rust | 📅 2026-05-07
...
* [WebGPU Samples](https://webgpu.github.io/webgpu-samples/) - A set of samples and demos demonstrating the use of the WebGPU API - [Repository](https://github.com/webgpu/webgpu-samples) ⭐ 2,122 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-16
