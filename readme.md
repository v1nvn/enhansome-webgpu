...
* [GPUWeb](https://github.com/gpuweb/gpuweb) ⭐ 5,406 | 🐛 485 | 🌐 Bikeshed | 📅 2026-06-09 - Official GitHub repository.
...
* [Implementation status](https://github.com/gpuweb/gpuweb/wiki/Implementation-Status) ⭐ 5,406 | 🐛 485 | 🌐 Bikeshed | 📅 2026-06-09 - Official W3C Group.
...
* [LearningWebGPU 教程 (Chinese)](https://github.com/hjlld/LearningWebGPU) ⭐ 558 | 🐛 7 | 🌐 TypeScript | 📅 2023-06-06 - By [@hjlld](https://github.com/hjlld).
...
* [wgpu](https://github.com/gfx-rs/wgpu) ⭐ 17,329 | 🐛 1,168 | 🌐 Rust | 📅 2026-06-10 - Mozilla implementation used in Firefox. Like Dawn, can be used as a standalone package.
* [sokol](https://github.com/floooh/sokol/) ⭐ 9,962 | 🐛 142 | 🌐 C | 📅 2026-06-09 - Simple STB-style cross-platform libraries for C and C++.
* [ChartGPU](https://github.com/chartgpu/chartgpu) ⭐ 3,124 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-01 - High-performance charting library built on WebGPU, handles 1M+ data points at 60fps.
* [React Native WebGPU](https://github.com/wcandillon/react-native-webgpu) ⭐ 1,131 | 🐛 45 | 🌐 TypeScript | 📅 2026-06-09 - React Native implementation of WebGPU using Dawn.
* [webgpu-headers](https://github.com/webgpu-native/webgpu-headers) ⭐ 568 | 🐛 49 | 🌐 C++ | 📅 2026-06-03 - C/C++ headers.
* [WebGPU-C++](https://github.com/eliemichel/WebGPU-Cpp) ⭐ 490 | 🐛 11 | 🌐 C++ | 📅 2025-09-03 - A single-file zero-overhead C++ idiomatic wrapper, by @eliemichel.
* [RedGPU](https://github.com/redcamel/RedGPU) ⭐ 379 | 🐛 12 | 🌐 TypeScript | 📅 2026-06-10 - JavaScript WbeGPU library, by [@redcamel](https://github.com/redcamel).
* [wgsl\_reflect](https://github.com/brendan-duncan/wgsl_reflect) ⭐ 274 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-08 - A WebGPU Shading Language parser and reflection library for JavaScript.
* [WESL](https://github.com/wgsl-tooling-wg/wesl-spec/blob/main/README.md) ⭐ 247 | 🐛 91 | 📅 2026-06-09 - WGSL extensions for `import`, `@if`, and more.
* [WebGPU .NET](https://github.com/WaveEngine/WebGPU.NET) ⭐ 199 | 🐛 0 | 🌐 C# | 📅 2026-04-07 - .NET bindings, built on top of wgpu.
* [WebRTX](https://github.com/codedhead/webrtx) ⭐ 160 | 🐛 3 | 🌐 Rust | 📅 2023-10-08 - WebGPU Ray Tracing Extension.
* [GEngine](https://github.com/hpugis/GEngine) ⭐ 146 | 🐛 7 | 🌐 JavaScript | 📅 2026-05-22 - A basic rendering engine based on WebGPU, by junwei.gu.
...
* [webgpu-inspector](https://github.com/brendan-duncan/webgpu_inspector) ⭐ 334 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-08 - Inspection debugger for WebGpu.
...
* [Three.js WebGPU examples](https://threejs.org/examples/?q=webgpu) - A collection of examples from three.js using the WebGPU renderer - [Repository](https://github.com/mrdoob/three.js/tree/dev/examples#:~:text=webgpu_compute.html) ⭐ 112,918 | 🐛 419 | 🌐 JavaScript | 📅 2026-06-09
* [WebLLM](https://mlc.ai/web-llm/) - LLM inference engine, by CMU, University of Washington, OctoML, et al - [Repository](https://github.com/mlc-ai/web-llm) ⭐ 18,156 | 🐛 146 | 🌐 TypeScript | 📅 2026-06-09
* [wgpu examples](https://wgpu.rs/examples/) - Official list of examples from the [wgpu](https://wgpu.rs) library - [Repository](https://github.com/gfx-rs/wgpu/tree/trunk/examples) ⭐ 17,329 | 🐛 1,168 | 🌐 Rust | 📅 2026-06-10
...
* [WebGPU Samples](https://webgpu.github.io/webgpu-samples/) - A set of samples and demos demonstrating the use of the WebGPU API - [Repository](https://github.com/webgpu/webgpu-samples) ⭐ 2,136 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-22
...
* [WebGPU 2D Fluid Simulation](https://kishimisu.github.io/WebGPU-Fluid-Simulation/) - An implementation of "Real-Time Fluid Dynamics for Games" paper, by [kishimisu](https://github.com/kishimisu) - [Repository](https://github.com/kishimisu/WebGPU-Fluid-Simulation) ⭐ 136 | 🐛 1 | 🌐 JavaScript | 📅 2023-08-28
...
* [WebGPU Memory Model Testing](https://gpuharbor.ucsc.edu/webgpu-mem-testing/) - Memory models testing suite, by [Reese Levine](https://github.com/reeselevine) et al., UC Santa Cruz - [Repository](https://github.com/reeselevine/webgpu-litmus) ⭐ 15 | 🐛 0 | 🌐 WGSL | 📅 2026-02-20
